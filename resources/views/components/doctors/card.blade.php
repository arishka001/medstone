<div
    ...
    @class([
        'doctor-card group flex cursor-pointer flex-col gap-5 rounded-3xl bg-[#FBFBFB] p-2.5 transition-all duration-300 hover:shadow-card active:shadow-card sm:gap-8.75 xl:gap-5 xl:p-5',
